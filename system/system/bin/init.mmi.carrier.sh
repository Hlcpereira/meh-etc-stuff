...
gabutton=`getprop ro.com.google.assistantchannel`
...
set_google_clientid_properties ()
{
    ...
    # If device has GA Button, ro.com.google.assistantchannel won't be empty
    if [ ! -z "$gabutton" ]; then
        setprop ro.mot.gms.clientidbase.vs `getprop ro.mot.gms.clientidbase.ms`
    fi
}
